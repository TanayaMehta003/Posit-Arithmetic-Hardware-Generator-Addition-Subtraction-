...
entity decoder_decoder_Pipeline_decoder_label1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of decoder_decoder_Pipeline_decoder_label1 is 
...
attribute shreg_extract : string;
    ...
    signal in_2_fu_58 : STD_LOGIC_VECTOR (5 downto 0);
    signal in_2_3_fu_164_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_in_2_2 : STD_LOGIC_VECTOR (5 downto 0);
    signal cnt2_fu_62 : STD_LOGIC_VECTOR (4 downto 0);
    signal cnt2_2_fu_130_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_sig_allocacmp_cnt2_1 : STD_LOGIC_VECTOR (4 downto 0);
    signal in_2_cast_fu_136_p1 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    cnt2_fu_62_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                if (((tmp_fu_122_p3 = ap_const_lv1_0) and (xor_ln951_fu_158_p2 = ap_const_lv1_0))) then 
                    cnt2_fu_62 <= cnt2_2_fu_130_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    cnt2_fu_62 <= ap_const_lv5_0;
                end if;
            end if; 
        end if;
    end process;

    in_2_fu_58_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                if (((tmp_fu_122_p3 = ap_const_lv1_0) and (xor_ln951_fu_158_p2 = ap_const_lv1_0))) then 
                    in_2_fu_58 <= in_2_3_fu_164_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    in_2_fu_58 <= ap_const_lv6_1E;
                end if;
            end if; 
        end if;
    end process;
    ...
    and_ln961_fu_146_p2 <= (shl_ln961_fu_140_p2 and num2_cast);
    ...
    ap_sig_allocacmp_cnt2_1_assign_proc : process(ap_CS_fsm_state1, ap_loop_init, cnt2_fu_62)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_sig_allocacmp_cnt2_1 <= ap_const_lv5_0;
        else 
            ap_sig_allocacmp_cnt2_1 <= cnt2_fu_62;
        end if; 
    end process;


    ap_sig_allocacmp_in_2_2_assign_proc : process(ap_CS_fsm_state1, in_2_fu_58, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_sig_allocacmp_in_2_2 <= ap_const_lv6_1E;
        else 
            ap_sig_allocacmp_in_2_2 <= in_2_fu_58;
        end if; 
    end process;

    cnt2_2_fu_130_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_cnt2_1) + unsigned(ap_const_lv5_1));
    cnt2_out <= ap_sig_allocacmp_cnt2_1;

    cnt2_out_ap_vld_assign_proc : process(ap_CS_fsm_state1, xor_ln951_fu_158_p2, tmp_fu_122_p3, ap_start_int)
    begin
        if ((((tmp_fu_122_p3 = ap_const_lv1_0) and (xor_ln951_fu_158_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1)) or ((tmp_fu_122_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1)))) then 
            cnt2_out_ap_vld <= ap_const_logic_1;
        else 
            cnt2_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    in_2_3_fu_164_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_in_2_2) + unsigned(ap_const_lv6_3F));
    in_2_cast_fu_136_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_in_2_2),31));

    in_2_out_assign_proc : process(ap_CS_fsm_state1, xor_ln951_fu_158_p2, tmp_fu_122_p3, ap_sig_allocacmp_in_2_2, ap_start_int)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
            if ((tmp_fu_122_p3 = ap_const_lv1_1)) then 
                in_2_out <= ap_const_lv6_3F;
            elsif (((tmp_fu_122_p3 = ap_const_lv1_0) and (xor_ln951_fu_158_p2 = ap_const_lv1_1))) then 
                in_2_out <= ap_sig_allocacmp_in_2_2;
            else 
                in_2_out <= "XXXXXX";
            end if;
        else 
    ...
    in_2_out_ap_vld_assign_proc : process(ap_CS_fsm_state1, xor_ln951_fu_158_p2, tmp_fu_122_p3, ap_start_int)
    begin
        if ((((tmp_fu_122_p3 = ap_const_lv1_0) and (xor_ln951_fu_158_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1)) or ((tmp_fu_122_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1)))) then 
            in_2_out_ap_vld <= ap_const_logic_1;
        else 
            in_2_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    p_Result_s_fu_152_p2 <= "0" when (and_ln961_fu_146_p2 = ap_const_lv31_0) else "1";
    shl_ln961_fu_140_p2 <= std_logic_vector(shift_left(unsigned(ap_const_lv31_1),to_integer(unsigned('0' & in_2_cast_fu_136_p1(31-1 downto 0)))));
    tmp_fu_122_p3 <= ap_sig_allocacmp_in_2_2(5 downto 5);
    xor_ln951_fu_158_p2 <= (p_Result_s_fu_152_p2 xor p_Result_18);
end behav;
