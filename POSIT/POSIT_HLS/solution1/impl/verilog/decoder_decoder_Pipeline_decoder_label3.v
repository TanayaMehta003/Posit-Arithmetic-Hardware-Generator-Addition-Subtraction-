...
module decoder_decoder_Pipeline_decoder_label3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_ready;
input  [1:0] expo2_V;
output  [31:0] exponent2_out;
output   exponent2_out_ap_vld;
...
reg   [1:0] y_1_reg_352;
reg   [1:0] y_1_reg_352_pp0_iter1_reg;
wire   [0:0] icmp_ln116_fu_134_p2;
reg   [0:0] icmp_ln116_reg_358_pp0_iter1_reg;
reg   [0:0] icmp_ln116_reg_358_pp0_iter2_reg;
wire   [31:0] y_2_cast_fu_140_p1;
wire   [0:0] p_Result_s_fu_173_p2;
reg   [0:0] p_Result_s_reg_367;
wire   [31:0] zext_ln118_fu_179_p1;
...
reg   [63:0] mul1_reg_387;
wire    ap_block_pp0_stage15_11001;
reg   [63:0] conv5_reg_392;
reg   [63:0] dc_reg_397;
...
reg   [1:0] y_fu_72;
wire   [1:0] y_2_fu_145_p2;
wire    ap_loop_init;
reg   [1:0] ap_sig_allocacmp_y_1;
reg   [31:0] exponent2_fu_76;
...
wire   [51:0] p_Result_40_fu_208_p1;
...
wire   [136:0] r_V_20_fu_276_p2;
wire   [31:0] zext_ln818_fu_290_p1;
wire   [31:0] tmp_1_fu_294_p4;
wire   [31:0] result_V_1_fu_312_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln116_reg_358 == 1'd0) & (1'b0 == ap_block_pp0_stage5_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        y_fu_72 <= 2'd0;
    end else if (((icmp_ln116_reg_358 == 1'd0) & (1'b0 == ap_block_pp0_stage15_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage15))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage8_11001) & (1'b1 == ap_CS_fsm_pp0_stage8))) begin
        p_Result_39_reg_402 <= data_V_fu_187_p1[32'd63];
...
always @ (posedge ap_clk) begin
    if ((((icmp_ln116_reg_358 == 1'd0) & (1'b0 == ap_block_pp0_stage5_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5)) | ((1'b0 == ap_block_pp0_stage6_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6)))) begin
        reg_115 <= grp_fu_1675_p_dout0;
    end
end

always @ (*) begin
    if (((icmp_ln116_reg_358 == 1'd1) & (1'b0 == ap_block_pp0_stage15_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage15))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage9_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage9) & (icmp_ln116_reg_358_pp0_iter2_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage9_11001) & (1'b1 == ap_CS_fsm_pp0_stage9) & (icmp_ln116_reg_358_pp0_iter2_reg == 1'd1))) begin
        exponent2_out_ap_vld = 1'b1;
    end else begin
        exponent2_out_ap_vld = 1'b0;
    end
end
...
assign and_ln779_fu_168_p2 = (shl_ln779_fu_162_p2 & expo2_V);
...
assign exponent2_out = exponent2_fu_76;
...
assign grp_fu_417_p_din0 = conv5_reg_392;

assign grp_fu_417_p_din1 = mul1_reg_387;
...
assign grp_fu_425_p_din1 = tmp_s_reg_377;
...
assign icmp_ln116_fu_134_p2 = ((ap_sig_allocacmp_y_1 == 2'd2) ? 1'b1 : 1'b0);

assign isNeg_fu_236_p3 = add_ln515_fu_230_p2[32'd11];

assign mantissa_fu_212_p4 = {{{{1'd1}, {p_Result_40_fu_208_p1}}}, {1'd0}};

assign p_Result_40_fu_208_p1 = data_V_fu_187_p1[51:0];

assign p_Result_s_fu_173_p2 = ((and_ln779_fu_168_p2 != 2'd0) ? 1'b1 : 1'b0);

assign r_V_20_fu_276_p2 = zext_ln15_fu_222_p1 << zext_ln1488_fu_266_p1;

assign r_V_fu_270_p2 = zext_ln15_fu_222_p1 >> zext_ln1488_fu_266_p1;

assign result_V_1_fu_312_p2 = (32'd0 - val_reg_407);

assign result_V_fu_317_p3 = ((p_Result_39_reg_402[0:0] == 1'b1) ? result_V_1_fu_312_p2 : val_reg_407);
...
assign tmp_1_fu_294_p4 = {{r_V_20_fu_276_p2[84:53]}};

assign tmp_fu_282_p3 = r_V_fu_270_p2[32'd53];

assign trunc_ln779_fu_155_p1 = y_1_reg_352_pp0_iter1_reg[0:0];

assign ush_fu_254_p3 = ((isNeg_fu_236_p3[0:0] == 1'b1) ? sext_ln1512_fu_250_p1 : add_ln515_fu_230_p2);

assign val_fu_304_p3 = ((isNeg_fu_236_p3[0:0] == 1'b1) ? zext_ln818_fu_290_p1 : tmp_1_fu_294_p4);

assign xs_exp_V_fu_198_p4 = {{data_V_fu_187_p1[62:52]}};

assign y_2_cast_fu_140_p1 = ap_sig_allocacmp_y_1;

assign y_2_fu_145_p2 = (y_1_reg_352 + 2'd1);

assign zext_ln118_fu_179_p1 = p_Result_s_reg_367;
...
assign zext_ln818_fu_290_p1 = tmp_fu_282_p3;

endmodule //decoder_decoder_Pipeline_decoder_label3
